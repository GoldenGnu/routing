...
public class SimpleUnisexMutatorEngine implements TSPEngine {
	 ...
	 */
	@Override
	public void initialize(TSPConfiguration appConfiguration, final Node cities[], final boolean loop) {
			...
			new Thread(new Runnable() {
				...
				public void run() {
					while (population.size() < populationSize) {
						TSPChromosome chromosome = new TSPChromosome(cities, loop);
	 ...
	 * @param cities
	 */
	public static void randomize(final Node[] cities) {
	...
	protected void getChild(TSPChromosome parent) {
		...
		Node newCities[] = parent.getCities();
	 ...
	 * @param cities
	 */
	protected void mutate(Node cities[]) {
